 ...
 *         &lt;element name="BusinessRegNum" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
...
public class Agent implements Serializable {
    ...
    @XmlElement(name = "Surname", namespace = "http://www.travel.com/agent", required = true)
    protected String surname;
    @XmlElement(name = "Email", namespace = "http://www.travel.com/agent", required = true)
    protected String email;
    @XmlElement(name = "Password", namespace = "http://www.travel.com/agent", required = true)
